...
def abrir_app():
    tela.destroy()
    subprocess.run(["python", "exemplomenu.py"])
...
txt_senha = Entry(tela, show='*', width=20)
...
btn_usuario =  Button(tela, text="Acessar", image= foto_acesso ,compound= TOP, command=validar_acesso).place(x=250,y=50)  
